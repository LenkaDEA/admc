...
: QMainWindow(parent) {
    ...
    // Setup theme action
    //
    const QList<QString> name_theme_list = settings_get_themes("NAME");
    const QList<QString> display_theme_list = settings_get_themes("DISPLAY_NAME");

    QList<QPair<QString, QString>> pair = setting_get_Sthemes();
